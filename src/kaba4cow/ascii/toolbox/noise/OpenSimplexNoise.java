...
public class OpenSimplexNoise {
	...
	private static final double STRETCH_CONSTANT_2D = -0.211324865405187d; // (1/Math.sqrt(2+1)-1)/2;
	private static final double SQUISH_CONSTANT_2D = 0.366025403784439d; // (Math.sqrt(2+1)-1)/2;
	private static final double STRETCH_CONSTANT_3D = -1d / 6d; // (1/Math.sqrt(3+1)-1)/3;
	private static final double SQUISH_CONSTANT_3D = 1d / 3d; // (Math.sqrt(3+1)-1)/3;
	private static final double STRETCH_CONSTANT_4D = -0.138196601125011d; // (1/Math.sqrt(4+1)-1)/4;
	private static final double SQUISH_CONSTANT_4D = 0.309016994374947d; // (Math.sqrt(4+1)-1)/4;

	private static final double NORM_CONSTANT_2D = 47d;
	private static final double NORM_CONSTANT_3D = 103d;
	private static final double NORM_CONSTANT_4D = 30d;
